...
from api.external-tools-service.app.services.external_tools_service import ExternalToolsService
...
@app.get("/oauth/providers", response_model=List[OAuthProviderDTO], tags=["OAuth Providers"])
...
@app.get("/oauth/providers/{provider_id}", response_model=OAuthProviderDTO, tags=["OAuth Providers"])
...
@app.post("/connections", response_model=ExternalToolConnectionDTO, tags=["Connections"])
...
@app.get("/connections", response_model=List[ExternalToolConnectionDTO], tags=["Connections"])
...
@app.get("/connections/{connection_id}", response_model=ExternalToolConnectionDTO, tags=["Connections"])
...
@app.post("/connections/{connection_id}/refresh", response_model=ExternalToolConnectionDTO, tags=["Connections"])
