from fastapi import FastAPI, Depends, HTTPException, Security, Query, Path, UploadFile, File, Form
...
from api.document-service.app.services.document_service import DocumentService
...
@app.get("/documents/{document_id}", response_model=DocumentResponseDTO, tags=["Documents"])
...
@app.put("/documents/{document_id}", response_model=DocumentResponseDTO, tags=["Documents"])
...
@app.get("/projects/{project_id}/documents", response_model=List[DocumentResponseDTO], tags=["Documents"])
...
@app.post("/documents/upload", response_model=DocumentUploadResponseDTO, tags=["Documents"])
...
@app.post("/documents/{document_id}/versions", response_model=DocumentVersionDTO, tags=["Document Versions"])
async def create_document_version(
    ...
    """
    document_service = DocumentService(db)
    return document_service.create_document_version(document_id, content_type, changes, user_id)


@app.get("/documents/{document_id}/versions", response_model=List[DocumentVersionDTO], tags=["Document Versions"])
...
@app.get("/documents/{document_id}/versions/{version}", response_model=DocumentVersionDTO, tags=["Document Versions"])
...
@app.post("/documents/{document_id}/permissions", response_model=DocumentPermissionDTO, tags=["Document Permissions"])
async def add_document_permission(
    ...
    """
    document_service = DocumentService(db)
    return document_service.add_document_permission(document_id, permission_data, user_id)


@app.put("/documents/{document_id}/permissions/{permission_id}", response_model=DocumentPermissionDTO, tags=["Document Permissions"])
async def update_document_permission(
    ...
    """
    document_service = DocumentService(db)
    return document_service.update_document_permission(document_id, permission_id, permission_data, user_id)


@app.delete("/documents/{document_id}/permissions/{permission_id}", tags=["Document Permissions"])
async def delete_document_permission(
    ...
    """
    document_service = DocumentService(db)
    return document_service.delete_document_permission(document_id, permission_id, user_id)


@app.get("/documents/{document_id}/permissions", response_model=List[DocumentPermissionDTO], tags=["Document Permissions"])
