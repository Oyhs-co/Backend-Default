...
from api.api-gateway.middleware.auth_middleware import auth_middleware
from api.api-gateway.middleware.circuit_breaker import circuit_breaker_middleware, circuit_breaker
from api.api-gateway.utils.service_registry import service_registry
...
async def forward_request(request: Request, target_url: str, service_name: str) -> JSONResponse:
    """
    Forward request to service.
