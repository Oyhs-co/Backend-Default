...
class ActivityService:
    ...
    def log_activity(self, project_id: str, user_id: str, action: str, entity_type: str, entity_id: str, details: Optional[Dict[str, Any]] = None) -> ActivityLogResponseDTO:
        """
        Log an activity.
    ...
    def get_project_activities(self, project_id: str, limit: int = 100, offset: int = 0) -> List[ActivityLogResponseDTO]:
        """
    ...
    def get_entity_activities(self, entity_type: str, entity_id: str, limit: int = 100, offset: int = 0) -> List[ActivityLogResponseDTO]:
        """
    ...
    def get_user_activities(self, user_id: str, limit: int = 100, offset: int = 0) -> List[ActivityLogResponseDTO]:
        """
