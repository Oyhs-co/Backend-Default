...
class TaskService:
    ...
    def create_task(self, project_id: str, task_data: TaskCreateDTO, user_id: str) -> TaskResponseDTO:
        """
        Create a new task.
    ...
    def update_task(self, project_id: str, task_id: str, task_data: TaskUpdateDTO, user_id: str) -> TaskResponseDTO:
        """
        Update a task.
        ...
        if not (is_task_creator or is_task_assignee or is_project_admin):
            raise InsufficientProjectRoleException("Only task creator, assignee, or project admin can update the task")
        ...
        if task_data.assignee_id is not None:
            ...
            if task_data.assignee_id:
                assignee_member = self.db.query(ProjectMember).filter(
                    ProjectMember.project_id == project_id,
    ...
    def delete_task(self, project_id: str, task_id: str, user_id: str) -> Dict[str, Any]:
        ...
        if not (is_task_creator or is_project_admin):
            raise InsufficientProjectRoleException("Only task creator or project admin can delete the task")
    ...
    def add_task_comment(self, project_id: str, task_id: str, comment_data: TaskCommentCreateDTO, user_id: str) -> TaskCommentResponseDTO:
        """
        ...
        if comment_data.parent_id:
            parent_comment = self.db.query(TaskComment).filter(
    ...
    def get_task_comments(self, project_id: str, task_id: str, user_id: str) -> List[TaskCommentResponseDTO]:
        """
