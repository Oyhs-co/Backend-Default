...
class ProjectService:
    ...
    def create_project(self, project_data: ProjectCreateDTO, user_id: str) -> ProjectResponseDTO:
        """
    ...
    def update_project(self, project_id: str, project_data: ProjectUpdateDTO, user_id: str) -> ProjectResponseDTO:
        """
        Update a project.
    ...
    def delete_project(self, project_id: str, user_id: str) -> Dict[str, Any]:
        ...
        if project_member.role != "owner":
            raise InsufficientProjectRoleException("Only project owner can delete the project")
    ...
    def update_project_member(self, project_id: str, member_id: str, member_data: ProjectMemberUpdateDTO, user_id: str) -> ProjectMemberResponseDTO:
        """
        ...
        member_to_update = self.db.query(ProjectMember).filter(
        ...
        if member_to_update.role == "owner" and member_data.role != "owner":
            ...
            if project_member.role != "owner":
                raise InsufficientProjectRoleException("Only project owner can transfer ownership")
        ...
        self.activity_service.log_activity(
            ...
            details={"user_id": member_to_update.user_id, "role": member_data.role}
        )
        
        # Return member
        return self._project_member_to_dto(member_to_update)
    
    def remove_project_member(self, project_id: str, member_id: str, user_id: str) -> Dict[str, Any]:
        """
        ...
        member_to_remove = self.db.query(ProjectMember).filter(
            ProjectMember.id == member_id,
            ProjectMember.project_id == project_id
        ).first()
        ...
        # Check if user has sufficient role
        if project_member.role not in ["owner", "admin"] and project_member.id != member_id:
            raise InsufficientProjectRoleException()
        ...
        self.activity_service.log_activity(
            ...
            details={"user_id": member_to_remove.user_id, "role": member_to_remove.role}
        )
    ...
    def get_project_members(self, project_id: str, user_id: str) -> List[ProjectMemberResponseDTO]:
        """
        Get project members.
    ...
    def _project_member_to_dto(self, project_member: ProjectMember) -> ProjectMemberResponseDTO:
        """
