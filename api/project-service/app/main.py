...
from api.project-service.app.schemas.project import (
    ProjectCreateDTO,
    ProjectUpdateDTO,
    ProjectResponseDTO,
...
from api.project-service.app.schemas.task import (
    TaskCreateDTO,
    TaskUpdateDTO,
    TaskResponseDTO,
...
from api.project-service.app.schemas.activity import ActivityLogResponseDTO
from api.project-service.app.services.project_service import ProjectService
from api.project-service.app.services.task_service import TaskService
from api.project-service.app.services.activity_service import ActivityService
from api.project-service.app.commands.task_commands import (
    CommandInvoker,
    UpdateTaskCommand,
    AssignTaskCommand,
...
@app.post("/projects/{project_id}/members", response_model=ProjectMemberResponseDTO, tags=["Project Members"])
...
@app.get("/projects/{project_id}/members", response_model=List[ProjectMemberResponseDTO], tags=["Project Members"])
...
@app.put("/projects/{project_id}/members/{member_id}", response_model=ProjectMemberResponseDTO, tags=["Project Members"])
async def update_project_member(
    ...
    """
    project_service = ProjectService(db)
    return project_service.update_project_member(project_id, member_id, member_data, user_id)
...
# Task endpoints
@app.post("/projects/{project_id}/tasks", response_model=TaskResponseDTO, tags=["Tasks"])
...
@app.get("/projects/{project_id}/tasks", response_model=List[TaskResponseDTO], tags=["Tasks"])
...
@app.get("/projects/{project_id}/tasks/{task_id}", response_model=TaskResponseDTO, tags=["Tasks"])
async def get_task(
    project_id: str = Path(..., description="Project ID"),
...
@app.put("/projects/{project_id}/tasks/{task_id}", response_model=TaskResponseDTO, tags=["Tasks"])
...
@app.post("/projects/{project_id}/tasks/{task_id}/comments", response_model=TaskCommentResponseDTO, tags=["Task Comments"])
...
@app.get("/projects/{project_id}/tasks/{task_id}/comments", response_model=List[TaskCommentResponseDTO], tags=["Task Comments"])
...
# Activity endpoints
@app.get("/projects/{project_id}/activities", response_model=List[ActivityLogResponseDTO], tags=["Activities"])
async def get_project_activities(
    ...
    project_service = ProjectService(db)
    project_service.get_project(project_id, user_id)  # This will raise an exception if user is not a project member
...
@app.post("/projects/{project_id}/tasks/{task_id}/assign", response_model=TaskResponseDTO, tags=["Task Commands"])
...
@app.post("/projects/{project_id}/tasks/{task_id}/status", response_model=TaskResponseDTO, tags=["Task Commands"])
...
@app.post("/projects/{project_id}/tasks/{task_id}/undo", response_model=TaskResponseDTO, tags=["Task Commands"])
...
@app.post("/projects/{project_id}/tasks/{task_id}/redo", response_model=TaskResponseDTO, tags=["Task Commands"])
